...
<div class="bg-amber-300 flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    <!--
                    ...
                    <x-slot:content>
                        ...
                        <div class="mt-6 flex gap-4">
                            ...
                            <a
                                ...
                                class="bg-blue-500				primary-button m-0 mx-auto block w-max rounded-2xl px-7 text-center text-base max-md:rounded-lg ltr:ml-0 rtl:mr-0"
                            >
