            ...
            <x-shop::drawer>
                ...
                <x-slot:header>
                    ...
                    <div class="flex items-center justify-between">
                        <p class="text-2xl font-medium max-md:text-xl max-sm:text-xl text-white ">
                            @lang('shop::app.checkout.cart.mini-cart.shopping-cart')
                        </p>
                    </div>

                    <p class="text-base max-md:text-zinc-500 max-sm:text-xs text-white">
                ...
                <x-slot:content>
                    ...
                    >
                        ...
                        <div class="grid flex-1 place-content-start justify-stretch gap-y-2.5">
                            <div class="flex justify-between gap-2 max-md:gap-0 max-sm:flex-wrap">
                                ...
                                >
                                        <p class="text-base font-medium max-md:font-normal max-sm:text-sm text-white">
                                            @{{ item.name }}
                                        </p>
                                    </a>
                                    ...
                                    <template v-if="displayTax.prices == 'including_tax'">
                                        <p class="text-lg max-md:font-semibold max-sm:text-sm text-white">
                                            @{{ item.formatted_price_incl_tax }}
                                        </p>
                                    </template>

                                    <template v-else-if="displayTax.prices == 'both'">
                                        <p class="flex flex-col text-lg max-md:font-semibold max-sm:text-sm text-white">
                                            @{{ item.formatted_price_incl_tax }}

                                            <span class="text-xs font-normal text-zinc-500 text-white">
                                ...
                                >
                                    ...
                                    <div class="">
                                        ...
                                        >
                                            ...
                                            <span
                                                class="text-2xl max-md:text-xl max-sm:text-lg text-white"
                                    ...
                                    >
                                        <template v-for="option in item.options">
                                            <div class="max-md:grid max-md:gap-0.5">
                                                <p class="text-sm font-medium text-zinc-500 max-md:font-normal max-sm:text-xs text-white">
                                                    @{{ option.attribute_name + ':' }}
                                                </p>
        
                                                <p class="text-sm max-sm:text-xs text-white">
                                                    @{{ option.option_label }}
                                                </p>
                                            </div>
                                        </template>
                                ...
                                <button
                                    type="button"
                                    class="text-blue-700 max-md:text-sm text-white"
                    ...
                    >
                        <div class="b-0 grid place-items-center gap-y-5 max-md:gap-y-0">
                            ...
                            <p
                                class="text-xl max-md:text-sm text-white"
                                role="heading"
                            >
                ...
                >
                    ...
                    >
                        ...
                        <template v-if="! isLoading">
                            <p class="text-sm font-medium text-zinc-500 text-white">
                        ...
                        <template v-else>
                            <p class="text-3xl font-semibold max-md:text-base text-white">
                        ...
                        <a
                            ...
                            class="cursor-pointer transition-all bg-blue-500 text-white px-3 py-2 rounded-lg
                                border-blue-600
                                border-b-[2px] hover:brightness-110 hover:-translate-y-[1px] hover:border-b-[6px]
                                active:border-b-[1px] active:brightness-90 active:translate-y-[1px]"
                        >
                            ...
                            <div class="block cursor-pointer text-center text-base font-medium max-md:py-1.5 text-white">
